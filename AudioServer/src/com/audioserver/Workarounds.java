...
public final class Workarounds {
    ...
    static {
        System.out.println("[Workarounds] static init starting");
        try {
            ...
            System.out.println("[Workarounds] static init failed: " + e);
            e.printStackTrace();
    ...
    public static void apply() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            ...
            System.out.println("[Workarounds] Filling ConfigurationController");
        ...
        if (mustFillAppInfo) {
            System.out.println("[Workarounds] Filling AppInfo");
            fillAppInfo();
        }
    ...
    public static AudioRecord createAudioRecord(int source, int sampleRate, int channelConfig, int channels, int channelMask, int encoding) throws
        ...
        try {
            ...
            if (initResult != AudioRecord.SUCCESS) {
                System.err.println("Error code " + initResult + " when initializing native AudioRecord object.");
            ...
            System.err.println("Cannot create AudioRecord: " + e);
            throw new Exception();
        }
    }
}